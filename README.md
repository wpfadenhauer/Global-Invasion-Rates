...
The following files include the raw data and R code used in the manuscript titled "Quantifying vulnerability to plant invasion across global ecosystems" (DOI: https://doi.org/10.1002/eap.3031). 
